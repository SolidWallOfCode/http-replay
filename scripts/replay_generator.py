...
def main():
    ...
    for i in range(1, total):
        ...
        client_req_node = {"version": "1.1", "scheme": "https", "method": "GET", "url": out_url}
        server_rsp_node = {"status": 200, "reason": "OK", "content": {"size": 6128}}
        ...
        transactions_node = {"uuid": uuid_str, "client-request": client_req_node, "proxy-request": proxy_req_node, "server-response": server_rsp_node, "proxy-response": proxy_rsp_node}
        transactions_array.append(transactions_node)

    session_node = [{"protocols": ["h2", "tcp", "ipv6"], "transactions": transactions_array}]
